...
/* 
 * Check function's end mark
 */
Context.prototype.checkEnd = function(name, mark) {
    return this.funcs.checkEnd(name, mark);
};

/* 
 * Get function's catch list
 */
Context.prototype.catch = function(name) {
    return this.funcs.catch(name);
};
